...
namespace Arena.Custom.Cccev.WebUtils.Search
{
    ...
    public class QueryRequest
    {
        ...
        /// <param name="sortDirection">The sort direction</param>
        /// <param name="sortOrder">The sort order</param>
        public void AddProperty( string name, IncludeInResults includeInResults, SortDirection sortDirection, int sortOrder )
        {
            // Get a new query property
            QueryProperty newProperty = new QueryProperty();
        ...
        private string BuildXmlQueryString()
        {
            ...
            AddContextElement(queryElement, this.QueryType, this.Language, this.QueryText, this.OriginatorContext);
        ...
        private void AddPropertiesElement(XmlElement queryElement, IList<QueryProperty> queryProperties)
        {
        ...
        private void AddBooleans(XmlElement queryElement, QueryRequest queryRequest)
        {
